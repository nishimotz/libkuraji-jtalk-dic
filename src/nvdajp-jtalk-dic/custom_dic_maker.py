...
jdic = [
	...
	# Tech terms and established loanwords
	["dropbox", "ドロップボックス", "0/7"],
	["Dropbox", "ドロップボックス", "0/7"],
	["python", "パイソン", "1/4"],
	["Python", "パイソン", "1/4"],
	["microsoft", "マイクロソフト", "4/6"],
	["Microsoft", "マイクロソフト", "4/6"],
	["copilot", "コパイロット", "2/5"],
	["Copilot", "コパイロット", "2/5"],
	["copilots", "コパイロッツ", "2/5"],
	["microsoftcopilot", "マイクロソフトコパイロット", "8/11"],
	["MicrosoftCopilot", "マイクロソフトコパイロット", "8/11"],
	# connect and derivatives
	["connect", "コネクト", "2/4"],
	["Connect", "コネクト", "2/4"],
	["connects", "コネクツ", "2/4"],
	["connected", "コネクテッド", "3/6"],
	["connecting", "コネクティング", "3/6"],
	["connection", "コネクション", "2/5"],
	["Connection", "コネクション", "2/5"],
	["connections", "コネクションズ", "2/6"],
	["connector", "コネクター", "2/5"],
	["connectors", "コネクターズ", "2/6"],
	["connectivity", "コネクティビティー", "5/9"],
	["disconnect", "ディスコネクト", "4/7"],
	["disconnects", "ディスコネクツ", "4/7"],
	["disconnected", "ディスコネクテッド", "5/9"],
	["disconnecting", "ディスコネクティング", "5/9"],
	["disconnection", "ディスコネクション", "4/8"],
	["disconnections", "ディスコネクションズ", "4/9"],
	["reconnect", "リコネクト", "3/5"],
	["reconnects", "リコネクツ", "3/5"],
	["reconnected", "リコネクテッド", "4/7"],
	["reconnecting", "リコネクティング", "4/7"],
	["reconnection", "リコネクション", "3/6"],
	# box and compounds
	["box", "ボックス", "0/4"],
	["Box", "ボックス", "0/4"],
	["boxes", "ボックシーズ", "3/5"],
	["boxed", "ボックスト", "0/4"],
	["boxing", "ボクシング", "0/4"],
	["checkbox", "チェックボックス", "4/7"],
	["checkboxes", "チェックボックシーズ", "4/8"],
	["textbox", "テキストボックス", "4/7"],
	["textboxes", "テキストボックシーズ", "4/8"],
	["combobox", "コンボボックス", "4/7"],
	["comboboxes", "コンボボックシーズ", "4/8"],
	["listbox", "リストボックス", "4/7"],
	["listboxes", "リストボックシーズ", "4/8"],
	["inbox", "インボックス", "3/5"],
	["inboxes", "インボックシーズ", "3/6"],
	["outbox", "アウトボックス", "3/6"],
	["outboxes", "アウトボックシーズ", "3/7"],
	["dialogbox", "ダイアログボックス", "6/9"],
	["dialogboxes", "ダイアログボックシーズ", "6/10"],
	["toolbox", "ツールボックス", "4/7"],
	["toolboxes", "ツールボックシーズ", "4/8"],
	["sandbox", "サンドボックス", "4/7"],
	["sandboxes", "サンドボックシーズ", "4/8"],
	["mailbox", "メールボックス", "4/7"],
	...
	["nazis", "ナチス", "1/3"],
	["datsun", "ダットサン", "3/5"],
	# Compound words across morphological boundary [t.s]
	["outside", "アウトサイド", "4/5"],
	["outsider", "アウトサイダー", "4/6"],
	["outsiders", "アウトサイダーズ", "4/7"],
	["outset", "アウトセット", "4/5"],
	["outsourcing", "アウトソーシング", "4/6"],
	["itself", "イットセルフ", "4/5"],
	["bestseller", "ベストセラー", "4/5"],
	["bestsellers", "ベストセラーズ", "4/6"],
	["whatsapp", "ワッツアップ", "4/5"],
	["whatsoever", "ワットソウエバー", "6/8"],
	["whiteside", "ホワイトサイド", "4/6"],
	["westside", "ウェストサイド", "5/6"],
	["stateside", "ステイトサイド", "5/6"],
	["shortsighted", "ショートサイティド", "5/8"],
	["sightseeing", "サイトシーイング", "4/7"],
	# Proper names with established Japanese readings
	["watson", "ワトソン", "1/4"],
	["robertson", "ロバートソン", "2/5"],
	["matson", "マットソン", "1/4"],
	["stetson", "ステットソン", "1/5"],
	["jetson", "ジェットソン", "1/5"],
	["yeltsin", "エリツィン", "2/4"],
	["yitzhak", "イツハク", "1/4"],
	["flotsam", "フロットサム", "2/5"],
	# Japanese proper names commonly written in romaji
	["matsumura", "マツムラ", "0/4"],
	["mitsuru", "ミツル", "0/3"],
	["atsushi", "アツシ", "0/3"],
	["tanaka", "タナカ", "0/3"],
