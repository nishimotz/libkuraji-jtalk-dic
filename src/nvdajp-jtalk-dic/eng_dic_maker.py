...
EXCLUDED_WORDS = frozenset((
    ...
    "originates",
    "originating",
    # Katakana loanword overrides (custom_dic_maker.py)
    "pizza",
    "pizzas",
    "pantsuit",
    "patsy",
    ...
    "nazis",
    "datsun",
    # Compound words across morphological boundary [t.s] (custom_dic_maker.py)
    "outside",
    "outsider",
    "outsiders",
    "outset",
    ...
    "shortsighted",
    "sightseeing",
    # Names with established Japanese katakana (custom_dic_maker.py)
    "watson",
    "robertson",
    "matson",
    "stetson",
    ...
    # Excluded from CMUdict so they don't produce Americanized pronunciations
    # (e.g. jujitsu -> ジュージットスー, karate -> カーアティー, sushi -> スーシー)
    "jujitsu",
    "jiujitsu",
    "jujutsu",
    "judo",
